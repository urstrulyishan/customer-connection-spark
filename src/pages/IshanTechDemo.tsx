...
export default function IshanTechDemo() {
  ...
  const completeOrder = () => {
    // Here we would normally call an API to process the order
    
    // Update local storage with the purchase for CRM integration
    if (currentCompany) {
      const purchaseData = {
        id: `purchase-${Date.now()}`,
        customer: "Ishan Prakash",
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="border rounded-md p-3">
                      <p><span className="font-medium">Name:</span> Ishan Prakash</p>
                      <p><span className="font-medium">Email:</span> ishan@ishantech.com</p>
